...
| The acknowledgment step protects people | After acting on the invented claim, can they say what approving it meant? | They describe approval as having verified or confirmed the claim |
...
4. **Comprehension probe (2 min), immediately after they act on the invented claim.** Before explaining anything, ask: **"What did approving that change mean?"** Then, if they do not raise it themselves: "What does the system now know about that sentence?" Nothing about provenance, evidence, or authorization is explained until after this answer is recorded. If I teach the concept first, I am testing my explanation rather than the interface.
...
- **Comprehension of the acknowledgment**, coded from the probe in step 4 rather than inferred from reading time. Time on the text is recorded too, but as a weak signal: a participant can stare at a warning and misread it, or skim it and grasp it exactly
  ...
  |---|---|
  | Full understanding | The claim has no supporting evidence; approving authorizes it without making it verified; the system records it as their assertion |
  | Partial understanding | Grasps that something is unsupported, but not what approval does to its status |
  | Misunderstood approval as verification | Believes approving made the claim confirmed, checked, or backed by the system |
  | Did not notice the distinction | No awareness that provenance differed between this change and the other one |

  Counts across six to ten participants are reported as descriptive usability findings ("four of eight read approval as verification"), never as rates in a population.
...
- If most participants code as *misunderstood approval as verification* or *did not notice the distinction*, the warning is theater regardless of how long they looked at it, and the answer is to block the unsupported claim outright rather than warn about it.
