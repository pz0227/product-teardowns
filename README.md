...
|---|---|---|---|---|
| <img src="https://www.google.com/s2/favicons?domain=claude.ai&sz=64" width="20" height="20" align="center"> **[Claude Code](./claude-code/teardown.md)** · [site ↗](https://claude.com/claude-code) | AI coding agent · SaaS | Developer tools | 📖 Living analysis · v1 | The model is no longer the bottleneck: every logged trust failure is about memory, continuity, and transparency, not code quality. |
